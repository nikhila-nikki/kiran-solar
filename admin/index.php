...
<body>
   ...
   <div class="menu-mobile  d-block d-lg-none">
    <ul class="d-flex justify-content-around">
      <li ><a href="index.html" ><i id="comments" class="fa fa-comments"></i></a></li>
      <li><a href="agent.html"><i id="user" class="fa fa-user"></i></a></li>
      <li><a href="agent-add.html"><i id="user-plus"class="fa fa-user-plus"></i></a></li>
    </ul>
   </div>
   ...
   <div class="m-5">
    ...
    <div class="table-responsive">
        <table class="table table-bordered" style="border:3px solid black;">
            <thead>
              <tr >
                <th scope="col " style="border:3px solid black;">No</th>
                <th scope="col " style="border:3px solid black;">Name</th>
                <th scope="col" style="border:3px solid black;">Email</th>
                <th scope="col" style="border:3px solid black;">Phonenumber</th>
                <th scope="col" style="border:3px solid black;">Alternative Phonenumber</th>
                <th scope="col" style="border:3px solid black;">Adress</th>
                <th scope="col" style="border:3px solid black;">Pincode</th>
                <th scope="col" style="border:3px solid black;">Avg:Monthly EB</th>
                <th scope="col" style="border:3px solid black;">Avg:Monthly Consumption</th>
                <th scope="col" style="border:3px solid black;">Connected Load</th>
...
$records = mysqli_query($db,"select * from solar"); // fetch data from database
...
?>
  <tr>
    ...
    <td  style="border:3px solid black;"><?php echo $data['name']; ?></td>
    <td style="border:3px solid black;"><?php echo $data['email']; ?></td>
    <td style="border:3px solid black;"><?php echo $data['phone']; ?></td>
    <td style="border:3px solid black;"><?php echo $data['alternative_phone']; ?></td>
    <td style="border:3px solid black;"><?php echo $data['address']; ?></td>
    <td style="border:3px solid black;"><?php echo $data['pincode']; ?></td>
    <td style="border:3px solid black;"><?php echo $data['monthly_elec_bill']; ?></td>
    <td style="border:3px solid black;"><?php echo $data['monthly_consumption']; ?></td>
    <td style="border:3px solid black;"><?php echo $data['connected_load']; ?></td>
