...
<ul class="d-flex justify-content-around">
  ...
  <li><a href="agent.php"><i id="user" class="fa fa-user"></i></a></li>
      ...
      <div class="row">
        ...
        <div class="col-sm-4 ">
           <div class="login-card">
            <form class="needs-validation"  action="agent.php" method ="POST" >
              
                <div class="mt-2">
                  <div class="form-group">
                    <label for="validationCustom01">District</label>
                    <select class="custom-select" required name="district">
                ...
                <div class="mt-3">
                  ...
                  <input type="text" class="form-control cst-input" pattern="^[1-9][0-9]{5}$"    name="pincode" id="pincode" placeholder="enter your pincode"  required>
                ...
                <div class="mt-3">
                  ...
                  <input type="text" class="form-control cst-input"   name="agentName" id="agentName" placeholder="enter agent name"  required>
                ...
                <div class="mt-3">
                  <label for="validationCustom01">Mobilenumber</label>
                  <input type="text" class="form-control cst-input" pattern="^[789]\d{9}$" name="mobile_number" id="mobile_number" placeholder="enter agent name"  required>
                  <div class="valid-feedback">
                    Looks good!
                  </div>
                  <div class="invalid-feedback">
                  ...
                  <label for="validationCustom01">Location Code</label>
                  <input type="text" class="form-control cst-input"  name="location_code" id="location_code" placeholder="enter location code"  required>
                ...
                <div class="text-center mt-5 mb-2">
                  <button class="btn login-button" type="submit" name="submit">ADD</button>
                </div>
                </form>
                <?php
                    ...
                    if(isset($_POST['submit']))
                        {	
                            ...
                            $insert=mysqli_query($db,"INSERT INTO agent( `district`,`pincode`,`agent-name`,`mobile`,`location`) 
                            VALUES 
                            ('$district','$pincode','$agentName','$mobile','$location')");
